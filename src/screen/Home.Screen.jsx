    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView className="flex-1">
        <View className="flex justify-center items-center h-[800px] px-5">
          ...
          <Text className="text-secondary w-full text-center px-5 text-sm mt-2" style={{fontFamily:"Titillium-Regular"}}>
            {/* Consult expertises in the field and discover the correct ways to
            your problems. Empower today! */}
          ...
          <View className="mt-16">
            <TouchableOpacity
              ...
              <Text className="text-lg font-medium text-white text-center" style={{fontFamily:"Titillium-Regular"}}>
                Start Consultation
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Text className="text-lg font-medium text-primary text-center" style={{fontFamily:"Titillium-Regular"}}>
                Schedule For Later
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View className="flex-1 justify-center mt-10 mx-5">
          <View className="w-full mx-auto">
            {/* ./../images/home2.png */}
            <Image
              source={require('./../images/xkop-home1.png')}
              className="w-full h-40 object-cover rounded-lg"
              resizeMode="cover"
            />
          </View>
          <Text className="text-primary text-lg font-medium pt-5" style={{fontFamily:"Ubuntu-R",fontWeight:"700"}}>
            {/* Empowering Individual */}
            Unrivaled Wisdom and Expertise
          </Text>
          <Text className="text-secondary text-base font-light mt-2" style={{fontFamily:"Titillium-Regular"}}>
        ...
        <View className="flex-1 justify-center mt-10 mx-5 mb-20">
          <View className="w-full mx-auto">
            {/* ./../images/home1.png */}
            <Image
              source={require('./../images/xkop-home2.png')}
              className="w-full h-40 object-cover rounded-lg"
              resizeMode="cover"
            />
          </View>
        ...
        <View className="flex-1 justify-center mt-10 mx-5 mb-20">
          <View className="w-full mx-auto">
            <Image
              source={require('./../images/xkop-home3.png')}
              className="w-full h-40 object-cover rounded-lg"
              resizeMode="cover"
            />
          </View>
