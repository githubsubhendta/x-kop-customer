...
//     useCallback(() => {
//       if (engine.current) {
//         console.log("Resetting mic and speaker settings...");
//         engine.current.muteLocalAudioStream(false); // Unmute mic
//         engine.current.setEnableSpeakerphone(true); // Enable speaker
//         setIsMuted(false);
